...
public class adapter1 extends RecyclerView.Adapter<adapter1.ProductViewHolder> {
    //accessing the products added to class
    private Context mCtx;
    private List<tripModel> modelList;
    String src;

    public adapter1(Context mCtx, List<tripModel> modelList) {
        this.mCtx = mCtx;
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        views = mInflater.inflate(R.layout.adaptercard2, parent, false);
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(View itemView) {
            ...
            tripName = itemView.findViewById(R.id.textView9);
